...
class GerenciarPartidasController {
    ...
    public function listarPartidas() {
        ...
        // Se for administrador, pega partidas dos campeonatos que ele criou
        // Se for organizador, pega partidas dos campeonatos criados pelo admin que o criou
        $query = "
        ...
        $query .= " ORDER BY p.data DESC, p.horario DESC";
