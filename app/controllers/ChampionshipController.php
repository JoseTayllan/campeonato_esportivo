...
class ChampionshipController
{
    ...
    public function criarCampeonato($nome, $descricao, $premiacao, $temporada, $formato, $modalidade, $criado_por, $times = [], $qr_code = null, $banner = null)
    {
        $campeonato_id = $this->campeonatoModel->criar($nome, $descricao, $premiacao, $temporada, $formato, $modalidade, $criado_por, $qr_code, $banner);
