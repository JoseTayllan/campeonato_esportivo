...
<div class="container-fluid py-2 border-bottom shadow-sm menu-container" style="background-color: var(--primary-color);">
    <div class="d-flex flex-row flex-nowrap  menu-scroll px-2 gap-2">
        ...
        <!-- Se estiver no contexto de edição de campeonato -->
        <?php if (isset($_GET['id'])): ?>
            <a href="/campeonato_esportivo/routes/adms/campeonato_editar.php?id=<?= $_GET['id'] ?>" class="menu-link menu-separador flex-shrink-0">
                <i class="bi bi-pencil-square me-2"></i>Editar Campeonato
            </a>

            <a href="/campeonato_esportivo/routes/adms/campeonato_editar_times.php?id=<?= $_GET['id'] ?>" class="menu-link menu-separador flex-shrink-0">
                <i class="bi bi-people-fill me-2"></i>Times do Campeonato
            </a>

            <a href="/campeonato_esportivo/routes/adms/campeonato_editar_rodadas.php?id=<?= $_GET['id'] ?>" class="menu-link flex-shrink-0">
                <i class="bi bi-calendar-week me-2"></i>Rodadas Campeonato
            </a>
        <?php endif; ?>
