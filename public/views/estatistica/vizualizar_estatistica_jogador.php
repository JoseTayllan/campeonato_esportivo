    ...
    <form method="GET" class="mb-4">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="jogador_nome" placeholder="Digite o nome do jogador" value="<?= isset($_GET['jogador_nome']) ? htmlspecialchars($_GET['jogador_nome']) : '' ?>">
            </div>
...
$(document).ready(function () {
    $("#selecionar_jogador").on("change", function () {
        ...
        if (jogadorId) {
            $("#exportar_csv").removeClass("disabled").attr("href", "../../../routes/exportar_dados.php?tipo=csv&jogador_id=" + jogadorId);
            $("#exportar_pdf").removeClass("disabled").attr("href", "../../../routes/exportar_dados.php?tipo=pdf&jogador_id=" + jogadorId);
        } else {
