    ...
    <main>
        <div class="container-fluid p-4">
            ...
            <form method="post" class="mb-3">
                <label for="link_transmissao">Link da Transmissão (YouTube)</label>
                <div class="input-group">
                    <input type="url" name="link_transmissao" id="link_transmissao" class="form-control"
                        placeholder="https://www.youtube.com/watch?v=abc123"
                        value="<?= $partida['link_transmissao'] ?? '' ?>">
                    <button class="btn btn-primary" type="submit" name="salvar_link">Salvar</button>
                </div>
            </form>
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-body">
                            ...
                            <p><span id="cronometro" class="fs-4">00:00</span>
                                <span id="acrescimo" class="badge bg-warning ms-2"></span>
                            </p>
