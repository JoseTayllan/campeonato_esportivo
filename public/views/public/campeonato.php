...
<div class="container mt-4">
    ...
    <a href="/routes/public/ranking_campeonato.php?campeonato_id=<?= $dados['campeonato']['id'] ?>" 
       class="btn btn-outline-primary btn-sm mb-3">
       🥇 Ver Ranking do Campeonato
    </a>
    <a href="/public/views/campeonatos/visualizar_fases_rodadas.php?campeonato_id=<?= $dados['campeonato']['id'] ?>"
            ...
            <?php foreach ($dados['times'] as $time): ?>
                <div class="col text-center">
                    <div class="border rounded p-2 h-100 bg-light">
                        <img src="/public/<?= $time['escudo'] ?? 'img/perfil_padrao/perfil_padrao.png' ?>" 
                        ...
                        <?php if (!empty($time['codigo_publico'])): ?>
                            <a href="/public/views/time/perfil_time.php?codigo=<?= urlencode($time['codigo_publico']) ?>" 
