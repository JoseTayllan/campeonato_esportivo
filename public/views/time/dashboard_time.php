...
<body class="bg-light d-flex flex-column min-vh-100">
    ...
    <div class="container py-5">
        <div class="card shadow p-4">
                    ...
                    <tbody>
                        <?php while ($jogador = $dados['jogadores']->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/campeonato_esportivo/routes/time/editar_jogador.php?id=<?= $jogador['id'] ?>"
                                        class="btn btn-sm btn-warning">
                                        Editar
                                    </a>

                                    <a href="/campeonato_esportivo/routes/time/remover_jogador.php?jogador_id=<?= $jogador['id'] ?>"
                                        class="btn btn-sm btn-danger"
                                        onclick="return confirm('Tem certeza que deseja remover este jogador do time?')">
                                        Remover do Time
                                    </a>
            ...
            <a href="/campeonato_esportivo/routes/time/buscar_jogadores.php" class="btn btn-primary mt-2">
                Buscar Jogadores no Sistema
            </a>
