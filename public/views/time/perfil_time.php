...
<body class="bg-light">
    <div class="container py-5">
        ...
        <!-- Aviso para rolar no mobile -->
        <div class="d-block d-md-none alert alert-info text-center p-2 mb-2" role="alert" style="font-size: 0.9rem;">
            🔄 Role a tabela para o lado para ver todos os dados.
        </div>
            ...
            <table class="table table-bordered align-middle text-center">
                ...
                <tbody>
                    <?php foreach ($jogadores as $j): ?>
                        <tr>
                            <td>
                                <img src="/campeonato_esportivo/public/img/jogadores/<?= $j['imagem'] ?: 'perfil_padrao/perfil_padrao.png' ?>"
                            ...
                            <td>
                                <a href="/campeonato_esportivo/routes/public/jogador.php?id=<?= $j['id'] ?>"
