            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white text-center">
                        <h5><i class="bi bi-person-circle me-2"></i>Editar Perfil - Organizador</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="/campeonato_esportivo/routes/adms/atualizar_perfil_organizador.php">
                            <div class="mb-3">
                        ...
                        <div class="mt-3 text-center">
                            <a href="/campeonato_esportivo/routes/adms/meus_campeonatos.php" class="text-decoration-none">
