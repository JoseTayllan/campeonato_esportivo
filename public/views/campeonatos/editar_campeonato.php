...
<div class="container mt-4">
    ...
    <form action="/routes/adms/campeonatos_atualizar.php" method="POST">
    ...
    <ul class="list-group mb-3">
        <?php foreach ($model->listarTimesPorCampeonato($campeonato['id']) as $time): ?>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <a href="/routes/adms/remover_time.php?campeonato_id=<?= $campeonato['id'] ?>&time_id=<?= $time['id'] ?>" class="btn btn-sm btn-danger">Remover</a>
            </li>
    ...
    <!-- Adicionar time -->
    <form method="POST" action="/routes/adms/adicionar_time.php" class="d-flex align-items-center gap-2 mb-5">
        ...
        <form method="POST" action="/routes/adms/adicionar_time_codigo.php" class="d-flex align-items-center gap-2 mb-5">
            <input type="hidden" name="campeonato_id" value="<?= $campeonato['id'] ?>">
        ...
        <?php foreach ($model->listarRodadas($campeonato['id']) as $rodada): ?>
            <li class="list-group-item">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="/routes/adms/excluir_rodada.php?id=<?= $rodada['id'] ?>&campeonato_id=<?= $campeonato['id'] ?>" class="btn btn-sm btn-danger">Excluir</a>
                </div>
                ...
                <?php if ($partidas): ?>
                    <ul class="mt-2">
                        <?php foreach ($partidas as $jogo): ?>
                            <li>
                                <form method="POST" action="/routes/adms/editar_partida.php" class="row g-2 align-items-center">
                                    ...
                                    <div class="col-md-2 d-flex gap-2">
                                        ...
                                        <a href="/routes/adms/excluir_partida.php?id=<?= $jogo['id'] ?>&campeonato_id=<?= $campeonato['id'] ?>" class="btn btn-sm btn-outline-danger">X</a>
                                    </div>
                ...
                <form method="POST" action="/routes/adms/adicionar_partida.php" class="row g-2 mt-2">
    ...
    <h5>Nova Rodada</h5>
    <form method="POST" action="/routes/adms/adicionar_rodada.php" class="row g-3">
        <input type="hidden" name="campeonato_id" value="<?= $campeonato['id'] ?>">
