        ...
        <?php foreach ($model->listarRodadas($campeonato['id']) as $rodada): ?>
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="/campeonato_esportivo/routes/adms/excluir_rodada.php?id=<?= $rodada['id'] ?>&campeonato_id=<?= $campeonato['id'] ?>" class="btn btn-sm btn-outline-danger">
                        Excluir
                    </a>
                </div>
                ...
                <div class="card-body">
                        ...
                        <?php foreach ($partidas as $jogo): ?>
                            <form method="POST" action="/campeonato_esportivo/routes/adms/editar_partida.php" class="row g-2 mb-3">
                                ...
                                <div class="col-md-2 d-flex gap-2">
                                    ...
                                    <a href="/campeonato_esportivo/routes/adms/excluir_partida.php?id=<?= $jogo['id'] ?>&campeonato_id=<?= $campeonato['id'] ?>" class="btn btn-sm btn-outline-danger">
                                        X
                                    </a>
                                </div>
                            </form>
                    ...
                    <!-- Novo jogo -->
                    <form method="POST" action="/campeonato_esportivo/routes/adms/adicionar_partida.php" class="row g-2">
